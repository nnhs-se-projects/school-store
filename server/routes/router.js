...
const SplashContent = require("../model/emailText").SplashContent;
...
route.get("/", async (req, res) => {
  ...
  //if the user has visited before, dont show splashpage
  ...
  let splashContent = "";
  try {
    const content = await SplashContent.findOne();
    if (content) {
      splashContent = content.content;
    }
  } catch (error) {
